...
public class ViewAllCommand extends Command {
    ...
    public CommandResult execute() {
        try {
            ...
            return new CommandResult(String.format(MESSAGE_VIEW_PERSON_DETAILS + "Sequence number is: " + Integer.toString(target.getSequenceNumber()), target.getAsTextShowAll()));
