...
> Address items are block, street, unit and postal code in that order. Unit only accepts numerical or - or # characters.
> Postal code only accepts numerical characters. Address can have 1 to 4 entries.
> 
...
Examples: 
* `add John Doe p/98765432 e/johnd@gmail.com a/block 123, John street, #01-01`
